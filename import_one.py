...
if arg.startswith("Q"):
    ...
    wikidata_item.get()
    print("after get")
    wikibase_importer.change_item(wikidata_item, wikibase_repo, claims)
elif arg.startswith("P"):
    wikidata_property = pywikibot.PropertyPage(wikidata_repo, arg)
    wikidata_property.get()
    wikibase_importer.change_property(wikidata_property, wikibase_repo, claims)
